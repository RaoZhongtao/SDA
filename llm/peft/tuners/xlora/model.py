...
from ...utils.constants import DUMMY_TARGET_MODULES
from ...utils.save_and_load import set_peft_model_state_dict
...
def _load_adapter_into_lora_model(
    ...
    **kwargs,
    ...
    from ...utils.save_and_load import load_peft_weights
