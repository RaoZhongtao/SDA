...
class LlamaRSEmb(LlamaPreTrainedModel):
    ...
    def forward(
        ...
        # print(f"Pooled logits shape: {pooled_logits.shape}")
        ...
        if labels is not None:
            ...
            print(f"Chosen logits shape: {chosen_logits.shape}, Rejected logits shape: {rejected_logits.shape}")
            print(f"Chosen logits: {chosen_logits}")
            print(f"Rejected logits: {rejected_logits}")
