...
def get_main_arguments(parser):
    ...
    parser.add_argument("--dataset", 
                        default="yelp", 
                        choices=["sports", "beauty", "toys", "steam", "douyin", "yelp", "tmall"], 
...
def get_model_arguments(parser):
    ...
    parser.add_argument("--lvlm_image_emb_file",
                        default="",
                        type=str,
                        help="the file name of the image embedding")
    parser.add_argument("--lvlm_text_emb_file",
                        default="",
                        type=str,
                        help="the file name of the text embedding")
    parser.add_argument("--cross_attn",
                        default=False,
                        action="store_true",
                        help="cross attention of image and text")
