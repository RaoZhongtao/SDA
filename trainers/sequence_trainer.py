...
class SeqTrainer(Trainer):
    ...
    def eval(self, epoch=0, test=False):
        ...
        if test:
            ...
            desc = 'Testing'
            model_state_dict = torch.load(os.path.join(self.args.output_dir, self.args.model_saved_name))
        ...
        for k, v in res_dict.items():
            if not test:
                ...
                wandb.log({
                    "Val_HR@10": res_dict["HR@10"],
                    "Val_NDCG@10": res_dict["NDCG@10"]
                })
        ...
        if test:
            ...
            wandb.log({
                "Overall HR@10": res_dict["HR@10"],
                "Overall NDCG@10": res_dict["NDCG@10"],
                "Short NDCG@10": res_len_dict["Short NDCG@10"],
                "Short HR@10": res_len_dict["Short HR@10"],
                "Long NDCG@10": res_len_dict["Long NDCG@10"],
                "Long HR@10": res_len_dict["Long HR@10"],
                "Tail NDCG@10": res_pop_dict["Tail NDCG@10"],
                "Tail HR@10": res_pop_dict["Tail HR@10"],
                "Popular NDCG@10": res_pop_dict["Popular NDCG@10"],
                "Popular HR@10": res_pop_dict["Popular HR@10"],
            })
    ...
    def save_user_emb(self):
        ...
        pickle.dump(user_emb, open("./data/{}/handled/usr_emb_{}_{}.pkl".format(self.args.dataset, self.args.model_name, self.args.hidden_size), "wb"))
    ...
    def save_item_emb(self):
        ...
        pickle.dump(item_emb, open("./data/{}/handled/itm_emb_{}_{}.pkl".format(self.args.dataset, self.args.model_name, self.args.hidden_size), "wb"))
