...
if [ "${MULTIMODAL_EMB}" == "True" ]; then
    TRAIN_FILE="multimodal_item_str_debug.jsonline"
    prefix="${fine_tune}_moe${NUM_MOE}_mean_${_date}"
else
    TRAIN_FILE="text_item_str.jsonline"
    prefix="text_${fine_tune}_${POOLING}_${_date}"
fi
...
# gpu_id=0
# seed_list=(42)
# llm_emb_file="moelora_moe4_mean_0611_infonce_late_concat_pca"
