...
LR=2e-4
model_choice="QwenVL"
model_name_or_path="/hpc2hdd/home/zrao690/Qwen2.5-VL-7B-Instruct"    # LLM底座模型路径，或者是huggingface hub上的模型名称
...
# if [ -d "$your_checkpopint_path/$dataset/$prefix/checkpoint-$MAX_STEPS" ]; then
#     echo "Checkpoint found. Starting inference..."
#     # 执行推理代码
...
#     --pool_type avg
# else
#     echo "Checkpoint not found. Please check the path: $your_checkpopint_path/$dataset/$prefix/checkpoint-$MAX_STEPS"
#     exit 1
# fi
...
gpu_id=0
seed_list=(42)
llm_emb_file="${prefix}_pooled_768"
