...
if [ "${MULTIMODAL_EMB}" == "True" ]; then
    ...
    if [ "${zero_shot}" == "True" ]; then
        prefix="${model_choice}_zero_0shot_${POOLING}_${_date}"
    else
        prefix="${model_choice}_${fine_tune}_moe${NUM_MOE}_${POOLING}_${_date}"
    fi
else
    TRAIN_FILE="multimodal_item_str.jsonline"
...
gpu_id=0
seed_list=(42)
llm_emb_file="QwenVL_zero_0shot_late_concat_1115_late_concat_pca"
