...
class LLMEmbSASRec(SASRecPLUS):
    ...
    def __init__(self, user_num, item_num, device, args):
        ...
        if args.hidden_size == 256:
            srs_item_emb = pickle.load(open("./data/{}/handled/itm_emb_sasrec_seq_256.pkl".format(args.dataset), "rb"))
        else:
            srs_item_emb = pickle.load(open("./data/{}/handled/itm_emb_sasrec_seq_128.pkl".format(args.dataset), "rb"))
...
class LLMEmbBert4Rec(Bert4RecPLUS):
    ...
    def __init__(self, user_num, item_num, device, args):
        ...
        super().__init__(user_num, item_num, device, args)
        srs_item_emb = pickle.load(open("./data/{}/handled/itm_emb_bert4rec_{}.pkl".format(args.dataset, args.hidden_size), "rb"))
...
class LLMEmbGRU4Rec(GRU4RecPLUS):
    ...
    def __init__(self, user_num, item_num, device, args):
        ...
        super().__init__(user_num, item_num, device, args)
        srs_item_emb = pickle.load(open("./data/{}/handled/itm_emb_gru4rec_{}.pkl".format(args.dataset, args.hidden_size), "rb"))
