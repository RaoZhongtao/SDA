...
def initWandb(args):
    ...
    wandb_run_name = f"{args.dataset}_{args.model_name}_{args.llm_emb_file}_{args.hidden_size}_alpha{args.alpha}"
    wandb_config = {
        "project": "MultimodalEmb", 
...
args.lvlm_text_emb_path = os.path.join("data/"+args.dataset+"/handled/", "{}.pkl".format(args.lvlm_text_emb_file))
args.lvlm_image_emb_path = os.path.join("data/"+args.dataset+"/handled/", "{}.pkl".format(args.lvlm_image_emb_file))
args.model_saved_name = f"pytorch_model_{args.llm_emb_file}_{args.hidden_size}_{args.alpha}.bin"
initWandb(args)  # initialize wandb
